        ...
        <div class="tm-main-content" id="top">
            ...
            <div class="tm-section tm-position-relative">
                ...
                <div class="container tm-pt-5 tm-pb-4"> 
                    <center><h4><font color="red">Search Results</font> - Location - <?php echo $search; ?> </h4> </center>
                    <div class="row">
                                <?php
                                    require_once 'Database.php';
                                    $connect = new Database();
                                    $db = $connect->db();
                                    $sql = "SELECT * FROM packages WHERE locations LIKE '%$search%' AND is_active = 1";
                                ...
                                <?php foreach ($packages as $package): ?>  
                                    <?php
                                        $pkgid = $package['id'];
                                    ?>  
                                  <article class="tm-bg-white col-sm-4 col-md-4 col-lg-4 col-xl-4 tm-article">
