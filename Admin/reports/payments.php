...
<html lang="en">
<head>
  <title>Travel Today Payments REPORT</title>
  <meta charset="utf-8">
...
<div class="jumbotron text-center">
  <h1>Travel Today Payments REPORT</h1>
</div>
...
<div class="container">
  ...
  $output .="<br><br><h3 style='color: grey; text-align:center;'>Travel Today Payments REPORT</h3><br>";    
 $output .="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'>
                <tr>
                  <th style='border: 1px solid #ddd;padding: 8px;padding-top: 12px;padding-bottom: 12px;text-align: left;background-color: #fb9640; color: white;'>Payment ID</th>
                  <th style='border: 1px solid #ddd;padding: 8px;padding-top: 12px;padding-bottom: 12px;text-align: left;background-color: #fb9640; color: white;'>Booking ID</th>
      ...
      $output.='
                  <tr>
                    ...
                    <td style="border: 1px solid #ddd;padding: 8px;"> '.$row['booking_id'].' </td>
    ...
    /*  $output .= '  <tr>
      ...
      $output .= '  <tr>
                  ...
                  $fileName = rand().'_Payments_Report_'.$current_date.'.pdf';
