                            ...
                            <form class="form" action="" method="POST">
                                ...
                                <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="first-name-column">Admin ID</label>
    ...
    <?php 
           ...
           if(isset($_POST['submit']))
           {
                ...
                if($password == ""){
                    ...
                    //create new instance 
                    $admin = new Admin(); 
                    $admin ->settings($firstname, $lastname, $email, $username, $address,$mobile, $user_id);
                }else{
                    $user_id = $userid;
                    $firstname = $_POST['firstname'];
                    $lastname = $_POST['lastname'];
                    ...
                    //create new instance 
                    $admin = new Admin(); 
                    $admin ->settings_with_pass($firstname, $lastname, $email, $username,$password,$address,$mobile, $user_id);
                }
           }
    ?>
</body>
