...
<head>
    ...
    <?php 
        ...
        if (isset($_POST['name'])){ 
            ...
            $customer ->sendMessage($name, $email, $subject, $message);
            ...
            <div class="tm-section tm-position-relative">
                ...
                <?php    if(isset($_GET['success']))
                         { ?>
                            ...
                            <h3 class="tm-color-primary tm-article-title-1">Messge Sent Success</h3>
                            <p>Thank You! We will contact you soon!</p>
                            </article>
                            <?php } else if(isset($_GET['failed'])){ ?>
                            <article class="col-sm-12 col-md-12 col-lg-12 col-xl-12 tm-article">                           
                            <i class="fa tm-fa-6x fa-life-saver tm-color-primary tm-margin-b-20"></i>
                            <h3 class="tm-color-primary tm-article-title-1">Messge Sent Failed</h3>
                            <p>Try Again!</p>
                            </article>
                           <?php } ?>
                    </div>       
